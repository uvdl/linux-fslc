...
static inline int cam_mipi_csi2_enable(cam_data *cam, uint32_t * mipi_id, uint32_t * mipi_vc, bool * mipi_en)
{
...
//		return -EPERM;
	...
	if (mipi_csi2_get_status(mipi_csi2_info)) {
		*mipi_en = true;
		*mipi_vc = 0;//mipi_csi2_get_virtual_channel(mipi_csi2_info);
		*mipi_id = mipi_csi2_get_datatype(mipi_csi2_info);
